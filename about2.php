    ...
    <header class="bg-#43C6AC text-white py-3">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
                <nav class="me-3">
                    <ul class="nav">
                        <li class="nav-item"><a href="user_dashboard.php" class="nav-link text-white">Home</a></li>
                        <li class="nav-item"><a href="gallery2.php" class="nav-link text-white">Gallery</a></li>
                        <li class="nav-item"><a href="about2.php" class="nav-link text-white">About</a></li>
                    </ul>
                </nav>
                <a href="home.php" class="btn btn-light btn-sm ms-3">Logout</a>
            </div>
        </div>
    </header>
