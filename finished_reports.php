                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if (file_exists($image_path)) {
                                ...
                                echo '<img src="default_image.jpg" width="200" height="200">';
                            }
                            ?>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="pdf_maker.php?id=<?php echo $report['id']; ?>" class="btn btn-success">Download PDF</a>
                            <a href="pdf_maker.php?id=<?php echo $report['id']; ?>&edit=true" class="btn btn-warning">Upload PDF</a>
                        </td>
                    </tr>
                    <?php
                }
