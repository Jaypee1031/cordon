...
<div class="container-fluid">
  ...
  <div class="col-md-9 animated bounce">
    <h1 class="page-header">Rejected Reports</h1>
    <ul class="breadcrumb">
      <li><span class="glyphicon glyphicon-home">&nbsp;</span>Home</li>
      <li><a href="#">Rejected Reports</a></li>
    </ul>
    <h2>Reports</h2>
    <table class="table table-hover ">
      ...
      <tbody>
        ...
        // Fetch rejected reports from the database
        $stmt = $conn->prepare("SELECT * FROM reports WHERE status = 'Rejected' ORDER BY created_at DESC");
        $stmt->execute();
        $reports = $stmt->get_result();
