...
// Fetch finished reports for the current year
$currentYear = date('Y');
$stmt = $conn->prepare("SELECT MONTH(created_at) as month, COUNT(*) as count FROM reports WHERE status='finished' AND YEAR(created_at) = ? GROUP BY month");
...
<head>
  <meta charset="UTF-8">
  <title>Semi-Annual Statistics - MDRRMO</title>
...
<div class="container-fluid">
  ...
  <div class="col-md-9 animated bounce">
    <h1 class="page-header">Semi-Annual Statistics</h1>
    <ul class="breadcrumb">
      <li><span class="glyphicon glyphicon-home">&nbsp;</span>Home</li>
      <li><a href="#">Statistics</a></li>
      <li class="active">Semi-Annual</li>
    </ul>

    <canvas id ="semi-annual-chart" width="400" height="200"></canvas>

    <script>
      const ctx = document.getElementById('semi-annual-chart').getContext('2d');
